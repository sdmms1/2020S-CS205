...
// ------------------------------------------------------
extern unsigned char *decimal_to_utf8(const unsigned int d, unsigned char *utf8);

extern unsigned char *codepoint_to_utf8(const unsigned int cp, unsigned char *utf8);
